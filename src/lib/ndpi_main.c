...
static void ndpi_init_protocol_defaults(struct ndpi_detection_module_struct *ndpi_mod) {
  ...
  u_int16_t no_master[2] = { NDPI_PROTOCOL_NO_MASTER_PROTO, NDPI_PROTOCOL_NO_MASTER_PROTO },
    ...
    ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_MS_LYNC,
			    ...
			    ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
    ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_WEIXIN,
			    no_master,
			    no_master, "WeiXin",
			    ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
    ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_SERVICE_YOUKU,
			    ...
			    ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
    ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_SERVICE_IQIYI,
			    no_master,
			    no_master, "IQIYI",
			    ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
			    ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
					  ...
					  const NDPI_PROTOCOL_BITMASK * dbm)
{
  ...
  /*IQIYI*/
  init_iqiyi_dissector(ndpi_struct, &a, detection_bitmask);
...
/* WORLD_OF_WARCRAFT */
  ...
  /*WEIXIN(Wechat)*/
  init_weixin_dissector(ndpi_struct, &a, detection_bitmask);
  /* ----------------------------------------------------------------- */
